...
import com.js.book.springboot.web.dto.PostsUpdateRequestDto;
...
public class PostsApiControllerTest {
    ...
    public void insertBaseTimeEntity() {
        LocalDateTime now = LocalDateTime.of(2020, 3, 26, 0, 0, 0);
        Posts savedPosts = postsRepository.save(Posts.builder()
                .title("title")
                .content("content")
                .author("author")
        ...
        //then
//        assertThat(list.get(0).getCreatedDate()).isEqualTo(now);
